...
## 🧩News
We proposed a large scale, high quality real 3D AD dataset(Mulsen-3D), following Real-3D and Anomaly-ShapeNet, which could be found here![[Paper]](https://github.com/ZZZBBBZZZ/MulSen-AD/))
## Introduction
